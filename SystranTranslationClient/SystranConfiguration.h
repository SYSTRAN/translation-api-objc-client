...
/** The `SystranConfiguration` class manages the configurations for the sdk.
 *
...
@class SystranApiClient;

@interface SystranConfiguration : NSObject

/**
 * Default api client
 */
@property (nonatomic) SystranApiClient *apiClient;
